...
template void PmergeMe::_merge_insertion_sort<std::vector<int> >(std::vector<int>&, int);
template void PmergeMe::_merge_insertion_sort<std::deque<int> >(std::deque<int>&, int);